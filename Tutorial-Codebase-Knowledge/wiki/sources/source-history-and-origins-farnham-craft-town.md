# Source: History and Origins Farnham Craft Town
...
- Farnham's geographical position has made it an important crossroads for
...
- By 803AD, Farnham had passed into the ownership of the Bishop of Winchester and so it remained (apart from two short breaks) for the next thousand years. By 1086, Farnham appears in the Domesday
- Book as Ferneham, one of the five great minster churches in Surrey. Its assets included 40 hides; one church, six watermills and 43 ploughs.
...
- The Middle Ages saw people coming from all over Hampshire and Surrey to
- buy and sell at a Farnham fair and we know that wool was being
- manufactured in Farnham at this time. The Black Death hit Farnham in 1348, killing about 1,300 people, at that time about a third of the population.
- In the 16th and 17th centuries, the wool cloth industry in Farnham prospered and became an important industry in the town. The wool was woven and
- then fulled. Fulling involved pounding the wool in a mixture of water and clay to clean and thicken it. The wool was pounded by wooden hammers worked by a watermill. The pottery industry also continued to be important and by this time the town was well known for its pots and was a major supplier to London.
...
- Farnham continued to change and develop in the 19 century with the opening of the railway station in 1849; the arrival of gaslight in 1834; the construction of the army camp at nearby Aldershot in 1854 and a network of sewers in the 1880s. These developments helped secure Farnham's future as a market town. th

---

## Backend-rag picture evidence

- API source_file: `History_and_Origins_Farnham_Craft_Town.annotated.arch_materials.description_classification.json`
...
- visual page `1` | `#/pictures/0` | class `other` | A cropped image showing a play button icon (a triangle pointing right) inside a rounded rectangular shape, followed by the word "YOUTUBE" in uppercase letters.
- visual page `1` | `#/pictures/1` | class `other` | A monochromatic, gray-toned graphic featuring a stylized bird icon to the left of the word "TWITTER," which is written in all caps.
- visual page `1` | `#/pictures/2` | class `map` | A horizontal rectangular crop featuring the text "Farnham's finest" in a gray, italicized script font on a plain white background.
- visual page `2` | `#/pictures/3` | class `other` | A cropped, grainy image showing the head and shoulders of a man with short, brown hair styled in a bowl cut and a matching beard. He has large eyes and prominent facial features. He appears to be depicted in a painting or icon-style portrait, wearing light-colored robes. No text is visible in the image.
- visual page `2` | `#/pictures/4` | class `building_interior` | A photograph shows a set of wide, dark gray or black steps in the foreground leading up to a landing where another set of stairs continues upward into a densely wooded area. The path between the two sets of stairs is covered with dirt and fallen leaves.

On both sides of the walkway, there are rustic wooden railings. To the right, the railing features vertical posts and horizontal rails, while on the left, it appears to be made of natural branches or logs. 

The entire area is surrounded by lush
...
- [alice-holt-forest-kilns](../buildings/alice-holt-forest-kilns.md)
- [farnham-castle](../buildings/farnham-castle.md)
- [farnham-heritage-sites](../collections/farnham-heritage-sites.md)
- [farnham-town](../places/farnham-town.md)
- [roman-way-estate](../buildings/roman-way-estate.md)
