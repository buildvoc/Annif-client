...
- API source_file: `Camouflage_development_Farnham_Castle_Trust.annotated.arch_materials.description_classification.json`
...
- visual page `1` | `#/pictures/0` | class `other` | A horizontal cropped image featuring a light gray or white play button icon (a triangle inside a rounded rectangle) followed by the word "YOUTUBE" in all caps on a solid gray background.
- visual page `1` | `#/pictures/1` | class `other` | A light gray graphic featuring a silhouette of a bird facing right, followed by the word "TWITTER" in all-capital, sans-serif letters.
- visual page `1` | `#/pictures/2` | class `map` | The image shows a narrow horizontal strip with a plain light gray background. In the center of the image, the words "Farnham's finest" are written in a stylized, italicized script font in a dark gray color.
- visual page `2` | `#/pictures/3` | class `other` | A cropped, artistic portrait showing the head and shoulders of a man with a prominent white and brown beard and mustache. He has hair that falls slightly forward toward his brow. He is shown wearing a plain, light-colored garment. There is no text in the image.
- visual page `2` | `#/pictures/4` | class `building_interior` | A wide set of wooden stairs leads upwards through an area filled with dense green foliage and trees. The stairs are constructed with dark horizontal planks. On the right side, there is a railing featuring weathered wooden posts and a metal handrail. A person stands at the top of the steps, facing away from the camera toward more greenery. No text is visible in the image.
...
- [camouflage-development-training-centre](../collections/camouflage-development-training-centre.md)
- [farnborough-airfield](../places/farnborough-airfield.md)
