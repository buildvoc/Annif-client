# Source: St Andrews Church Farnham Wikipedia

**Summary**: Source page generated from DoclingDocument JSON.

**Raw file**: raw/docling-json/St_Andrews_Church_Farnham_Wikipedia.annotated.arch_materials.description_classification.json
...
- On 16 February 1487, the parish obtained a licence from King Henry VII to get a curate for the church. In addition, a chantry chapel was built on the north side of the church, dedicated to the Virgin Mary. In the early 16th century, a new tower was built at the west end of the church; it was quite small, rising up no more than a couple of metres above the roof of the nave. Later, with Henry VIII's Abolition of Chantries Acts in 1545 and 1547, the chantry chapel
- St Andrew's Church, Farnham
- The church from the northwest
- Location in Surrey 51°12′48″N 0°48′03″W
- StAndrewsFarnham.org (ht
- tp://www.standrewsfarnha m.org/)
- Functional status Active
- was abolished, the objects it contained were sold off, and it was turned into a school room. In 1758, it was sold off and demolished to pay for church repairs. [3]
...
- Andrew Partridge, Robert Thain
- Andrew Partridge, Richard Haines
...
- The stonework of the east window has not changed since the Middle Ages, but the present glass was installed in the 19th century. It was designed by the notable architect, Augustus Pugin, and made by Hardman & Co. in 1851. It shows an example of Pugin designing in a style that he found
- 15th-century baptismal font
- problematic at times, showing elaborate group compositions under canopies and illustrating events from the life of Christ. [5]
...
- On display at the back of the church is a copy of the Vinegar Bible; it was presented to the church in 1731 by Arthur Onslow. [4] Also in the church is a plaque to Augustus Toplady, who wrote the hymn 'Rock of Ages'. He was born in Farnham and baptised in the parish church in 1740. [4]
...
- API source_file: `St_Andrews_Church_Farnham_Wikipedia.annotated.arch_materials.description_classification.json`
...
- visual page `1` | `#/pictures/0` | class `other` | A horizontal rectangular graphic featuring the YouTube logo in gray on a white background. On the left is an icon consisting of a rounded rectangle with a right-pointing triangle inside it, and to its right is the text "YOU TUBE" in capital letters.
- visual page `1` | `#/pictures/1` | class `other` | A gray-colored logo for the social media platform Twitter. It features a stylized bird icon on the left followed by the word "TWITTER" in all capital letters to its right.
- visual page `1` | `#/pictures/2` | class `map` | A wide banner image featuring the phrase "Farnham's finest" written in a black, cursive script font on a white background.
- visual page `2` | `#/pictures/3` | class `other` | A close-up portrait painting depicts the head and shoulders of a man. He has short, dark hair styled straight across his forehead and a thick, textured beard and mustache in shades of brown and grey. His facial expression appears solemn. He is wearing a garment with a large, prominent collar. The image features muted tones and visible textures consistent with a painting or aged sketch. No text is visible.
- visual page `2` | `#/pictures/4` | class `building_interior` | A set of stone steps leads upward through a wooded area with thick green foliage and trees on both sides. The foreground shows several wide, dark-toned steps under dappled sunlight. In the middle ground, two people can be seen near the top of this initial section of stairs. A metal railing runs along the right side of the path. There is no text visible in the image.
...
- [church-sites](../collections/church-sites.md)
- [farnham](../places/farnham.md)
- [st-andrews-church-farnham](../buildings/st-andrews-church-farnham.md)