# Source: 2 3 4 WEST STREET Farnham 1258090 Historic England
...
- 1099 WEST STREET (South East Side) SU8346 NE 5/162 II
...
- Listing NGR: SU8389546810
- The contents of this record have been generated from a legacy data system.
- Legacy System number:
- This building is listed under the Planning (Listed Buildings and Conservation Areas) Act 1990 as amended for its special architectural or historic interest.
- This map is for quick reference purposes only and may not be to scale. This copy shows the entry on 07-Mar2026 at 15:51:10.
...
- API source_file: `2_3_4_WEST_STREET_Farnham_1258090_Historic_England.annotated.arch_materials.description_classification.json`
...
### Uncertainties
- LLM failed: HTTPConnectionPool(host='host.docker.internal', port=11434): Max retries exceeded with url: /api/generate (Caused by NewConnectionError('<urllib3.connection.HTTPConnection object at 0x79712981feb0>: Failed to establish a new connection: [Errno -2] Name or service not known'))
