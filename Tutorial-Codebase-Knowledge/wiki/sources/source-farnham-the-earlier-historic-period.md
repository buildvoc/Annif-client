...
- API source_file: `Farnham_The_Earlier_Historic_period.annotated.arch_materials.description_classification.json`
...
- visual page `1` | `#/pictures/0` | class `other` | A horizontal banner-style image features a gray play button icon (a rounded rectangle containing a right-pointing triangle) followed by the text "YOU TUBE" in all capital letters. Both elements are rendered in a similar shade of gray against a plain light background.
- visual page `1` | `#/pictures/1` | class `other` | A horizontal, wide-format image contains a light gray stylized bird icon (the Twitter logo) on the left, followed by the word "TWITTER" in all capital letters in the same light gray color.
- visual page `1` | `#/pictures/2` | class `map` | The image shows a horizontal banner with the words "Farnham's finest" written in a gray, cursive-style font on a plain white background.
- visual page `2` | `#/pictures/3` | class `other` | A cropped portrait showing a close-up of a man's head and shoulders. The man has dark hair, a thick beard, and a mustache. He has a somber expression and is looking forward. He wears light-colored clothing with some pattern or texture near the neck and a piece of fabric framing his face. The image appears to be in the style of an icon or traditional painting. 

No text is visible in the image.
- visual page `2` | `#/pictures/4` | class `building_interior` | A close-up outdoor shot shows wide, dark steps leading upward into a wooded area. A rustic railing made of logs or thick branches runs along the right side of the stairs. On the left, there is a fence covered in green foliage. At the top of the steps, a person wearing a white shirt and black pants stands near some wooden structures amidst dense green trees and bushes. No text is visible.
...
- [downing-street](../streets/downing-street.md)
- [farnham](../places/farnham.md)
- [lower-church-lane](../streets/lower-church-lane.md)
- [medieval-town-planning](../collections/medieval-town-planning.md)
- [st-andrews](../buildings/st-andrews.md)
- [the-borough](../streets/the-borough.md)